...
class Timer(tk.Frame):
    def __init__(self, parent):
        ...
        self.hours_frame = tk.LabelFrame(self.spinbox_frame,
                                         text="Set starting hours:", bg= "black", fg="yellow")
        self.hours_select = tk.Spinbox(self.hours_frame, from_=0, to=99,
                                       width=5, bg= "black", fg="pink", textvariable=self.start_hours,
                                       font=Font(family='Helvetica', size=36,
                                                 weight='bold'))
        self.minutes_frame = tk.LabelFrame(self.spinbox_frame, bg= "black", fg="yellow",
                                           text="Set starting minutes:")
        self.minutes_select = tk.Spinbox(self.minutes_frame, from_=0, to=59,
                                         textvariable=self.start_minutes, bg= "black",  fg="pink",
                                         font=Font(family='Helvetica', size=36,
                                                   weight='bold'),
                                         width=5)
        self.seconds_frame = tk.LabelFrame(self.spinbox_frame,
                                           text="Set starting seconds:", bg= "black", fg="yellow")
        self.seconds_select = tk.Spinbox(self.seconds_frame, from_=0, to=59,
                                         textvariable=self.start_seconds,  bg= "black",  fg="pink",
                                         font=Font(family='Helvetica', size=36,
                                                   weight='bold'),
                                         width=5)
        ...
        self.active_button = tk.Button(self.button_frame, text="Start",
                                       command=self.start, font=Font(family='Helvetica', size=18,
                                                   weight='bold'), bg="green", fg="white")
        self.stop_button = tk.Button(self.button_frame, text="Stop",
                                     command=self.stop, font=Font(family='Helvetica', size=18,
                                                   weight='bold'), bg="red", fg="white")
