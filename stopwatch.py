...
class Stopwatch(tk.Frame):
    def __init__(self, parent):
        ...
        self.clock = tk.Label(self.left, text=str(self.time), bg="black", fg = "pink",
                              font=Font(family='Helvetica', size=36,
                                        weight='bold'))
        self.button_frame = tk.Frame(self.left)
        self.active_button = tk.Button(self.button_frame, text="Start", command=self.start, font=("bold", "18"), bg = "green", fg="black",  width="10")
        self.restart_button = tk.Button(self.button_frame, text="Restart", width="10",
                                        command=self.restart, font=("bold", "18"), bg = "lightgreen", fg="black")
        self.save_button = tk.Button(self.button_frame, text="Save time", command=self.save, font=("bold", "18"),  width="10", bg = "lightblue", fg="black")
        self.clear_button = tk.Button(self.button_frame, text="Clear times",
                                      command=self.clear, font=("bold", "18"), bg = "red", fg="black",  width="10")
